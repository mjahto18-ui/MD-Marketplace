// lib/taxi/pricingEngine.js - نهائي 4 جداول - مصلح toktok/tuktuk و van
...
export function calculateFare({ cityKm, highwayKm, totalKm, engineCode = '1500', area = 'default', vehicle_type, routeKey = 'default', pricingBundle }) {
  ...
  // ✅ نستعمل نوع المركبة يلي طلبها الزبون مش نوع المحرك - مع تصليح tuktuk/toktok
  const requestedType = normalizeVehicleType(vehicle_type || engine.vehicle_type);
