        ...
        <div className="relative mx-auto grid max-w-7xl items-center gap-12 px-5 py-16 lg:grid-cols-2 lg:py-24">
          ...
          <div className="order-2 flex justify-center lg:order-1">
            ...
            <div className="relative w-full max-w-">
              ...
              {/* SPEECH BUBBLE */}
              <div className="absolute -right-3 -top-7 hidden max-w- rounded-3xl bg-white p-4 text-center text-sm font-bold shadow-xl sm:block">
