...
import GuestStatsMap from "@/components/GuestStatsMap";
    ...
    <div className="p-4 space-y-4">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
        <div className="bg-white rounded-xl shadow p-4 border">
          <div className="text-xs text-gray-500">إجمالي الزيارات المحللة</div>
      ...
      <div className="bg-white rounded-xl shadow border overflow-hidden">
        <div className="p-3 font-bold border-b">خريطة الزوار العالمية - للاحصاء فقط</div>
      ...
      <div className="bg-white rounded-xl shadow border p-4">
        <div className="font-bold mb-2">توزيع حسب البلد - مشان الاعلان</div>
        <div className="text-xs text-gray-500">هون بتعرف وين تعمل اعلان ممول</div>
      </div>
    </div>
  )
}
