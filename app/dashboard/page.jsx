          ...
          <div className="flex items-center gap-2">
            ...
            <div className="relative">
              ...
              >
                ...
                {openNotifications && (
                <div className="absolute left-0 top-full mt-3 w-[92vw] max-w-[300px] bg-[#1a1a1a] text-white shadow-2xl rounded-xl p-3 z-50 border border-white/10 max-h-[70vh] overflow-y-auto">
