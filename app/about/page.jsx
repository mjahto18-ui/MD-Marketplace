            ...
            <div className="border-t border-gray-100 pt-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <a href="https://facebook.com/mdmarketplaceofficial" target="_blank" className="group bg-gradient-to-br from-blue-50 to-indigo-50 border border-[#1877F2]/10 rounded-2xl p-5 text-center hover:shadow-md hover:border-[#1877F2]/30 transition-all">
                  ...
                  <p className="text-sm font-semibold text-[#0D0D21] mb-1">فيسبوك</p>
                  <p className="text-xs text-[#1877F2] font-medium group-hover:text-[#0a59c1] transition">mdmarketplaceofficial</p>
                </a>

                {/* Instagram - لاحقاً */}
                <a href="https://instagram.com/mdmarketplace.lb" target="_blank" className="group bg-gradient-to-br from-purple-50 to-pink-50 border border-[#E4405F]/10 rounded-2xl p-5 text-center hover:shadow-md hover:border-[#E4405F]/20 transition-all opacity-80">
                ...
                {/* TikTok - لاحقاً */}
                <a href="https://tiktok.com/@mdmarketplace.lb" target="_blank" className="group bg-gradient-to-br from-gray-50 to-slate-50 border border-black/10 rounded-2xl p-5 text-center hover:shadow-md hover:border-black/20 transition-all opacity-80">
                  ...
                  <p className="text-sm font-semibold text-[#0D0D21] mb-1">تيك توك</p>
                  <p className="text-xs text-black font-medium">قريباً</p>
                </a>
