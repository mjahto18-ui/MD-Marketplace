  ...
  <div className="min-h-screen bg-gray-50">
    ...
    <div className="container mx-auto px-4 py-16">
      ...
      <div className="flex flex-col items-center mb-12">
        <div className="bg-white p-4 rounded-xl shadow-xl mb-5">
          <Image
            src="/icon.png"
            alt="MD-Marketplace"
            width={125}
      ...
      {/* النص الرسمي الجديد - محمي قانونيا - نادي خاص مغلق */}
      <div className="max-w-4xl mx-auto text-center">
        ...
        <p className="text-lg text-[#0D0D21] mb-8 leading-relaxed">
          منصّة متكاملة ونادي رقمي خاص مغلق Private Digital Club يجمع العملاء، المتاجر، والأعضاء الناقلين الموثقين بـ User ID ضمن تطبيق واحد، لتقدّم تجربة تسوّق وتنسيق لوجستي داخلي مغلق حديثة، سريعة، وآمنة، مصمّمة لتلبية احتياجات السوق اللبناني. نحن وسيط تقني فقط ولسنا شركة نقل ولا نملك أسطول سيارات. نعمل على توفير بيئة موثوقة تجمع بين سهولة الاستخدام، وضمان الجودة، ووضوح الإجراءات، بهدف تقديم خدمة رقمية عالية المستوى داخل عائلة المنصة فقط.
        </p>
        ...
        <div className="bg-white rounded-3xl shadow-lg p-8 mb-8 text-right">
          ...
          <h3 className="text-2xl font-bold text-[#6A11CB] mb-6">
            MD-Marketplace - وساطة تقنية فقط
          </h3>

          <p className="text-[#0D0D21] mb-4">
            MD-Marketplace هو نظام رقمي موحّد ونادي خاص مغلق يسهّل عملية الشراء والتنسيق اللوجستي بين عضوين مستقلين موثقين داخل النادي، ويقدّم خدمات مرنة تلائم احتياجات المستخدم اليومية. كل طلب هو اتفاق مباشر بين عضوين - المنصة وسيط عرض فقط ولا تتحمل تبعاته.
          </p>

          <ul className="space-y-4 text-[#0D0D21]">
            <li>✓ خيارات دفع مناسبة: الدفع نقداً عند الاستلام أو عبر نظام Wish لضمان الحق</li>
            <li>✓ خمس توصيلات مجانية لأول خمسة طلبات حتى وزن 10 نقاط لأعضاء النادي الموثقين</li>
            <li>✓ تتبّع مباشر لحالة الطلب لحظة بلحظة عبر نظام الخرائط - أثناء الطلب النشط فقط</li>
            <li>✓ بيئة مغلقة: الدخول فقط بـ User ID نشط ومعتمد - يمنع تقديم الخدمة خارج النادي</li>
          </ul>
        ...
        <div className="bg-white rounded-3xl shadow-lg p-8 mb-8 text-right">
          ...
          <p className="text-[#0D0D21] mb-4">
            نلتزم بتطبيق أعلى معايير الخصوصية وحماية البيانات لضمان تجربة آمنة وواضحة لجميع أعضاء النادي المغلق. بياناتك لا تشارك خارج النادي.
          </p>

          <ul className="space-y-4 text-[#0D0D21]">
            <li>✓ إخفاء معلوماتك الشخصية عن العضو الناقل قبل قبول الطلب الموثق داخل النادي</li>
            <li>✓ جميع الأعضاء الناقلين معتمدون بمستندات رسمية (رخصة سوق + دفتر سيارة + تأمين) وموثقين بـ User ID نشط لضمان الثقة</li>
            <li>✓ العضو الناقل مستقل Independent Contractor وليس موظفاً - يتحمل وحده مسؤولية قانونية سيارته والتزامه بقوانين السير - يمنع التقاط ركاب من الشارع</li>
          </ul>
        ...
        <div className="bg-white rounded-3xl shadow-lg p-8 mb-8 text-right">
          ...
          <p className="text-[#0D0D21] mb-3">
            <strong>خدمة "طلب خاص"</strong> — كعضو موثق في النادي، يمكنك طلب أي منتج من أي مكان، وسيقوم عضو ناقل موثق بشرائه وتسليمه مباشرة إلى باب منزلك، مع متابعة دقيقة لحالة الطلب حتى وصوله.
          </p>
          <p className="text-[#0D0D21]">
            <strong>خدمة "توصيلة خاصة"</strong> — تنسيق رحلات خاصة بين عضوين موثقين داخل النادي المغلق فقط (وليست خدمة تاكسي عامة عشوائية) - السعر مقترح من النظام والاتفاق النهائي بين العضوين.
          </p>
        ...
        <div className="bg-white rounded-3xl shadow-lg p-8 mb-8 text-right">
          ...
          <p className="text-[#0D0D21]/70 mb-6">
            نرحّب بجميع الاستفسارات والملاحظات من أعضاء النادي، ونتعهّد بالرد خلال 24 ساعة عبر قنوات التواصل التالية:
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
            ...
            <a
              ...
              className="group bg-gradient-to-br from-purple-50 to-pink-50 border border-purple-100 rounded-2xl p-5 text-center hover:shadow-md hover:border-purple-200 transition-all"
            >
          ...
          <div className="border-t border-gray-100 pt-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <a
                ...
                target="_blank"
                className="group bg-gradient-to-br from-blue-50 to-indigo-50 border border-blue-100 rounded-2xl p-5 text-center hover:shadow-md hover:border-blue-200 transition-all"
              >
              ...
              <a
                ...
                target="_blank"
                className="group bg-gradient-to-br from-red-50 to-pink-50 border border-red-100 rounded-2xl p-5 text-center hover:shadow-md hover:border-red-200 transition-all"
              >
      ...
      <div className="border-t border-purple-200 pt-8 pb-4">
        <div className="flex items-center justify-center gap-6 text-sm">
          <Link
            href="/privacy"
            className="text-[#6A11CB] hover:text-[#FF4E9A] transition font-medium"
          >
            سياسة الخصوصية - نادي خاص مغلق
          </Link>
        ...
        <p className="text-xs text-[#0D0D21]/60 mt-4 text-center">
          © 2020-2026 MD Marketplace - نادي رقمي خاص مغلق - وسيط تقني فقط - جميع الحقوق محفوظة
        </p>
      </div>
