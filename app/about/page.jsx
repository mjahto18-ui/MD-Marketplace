          ...
          <div className="bg-white rounded-3xl shadow-lg p-8 mb-8 text-right">
            ...
            <div className="border-t border-gray-100 pt-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                {/* TikTok - لاحقاً */}
                <a href="https://tiktok.com/" target="_blank" className="group bg-gradient-to-br from-gray-50 to-slate-50 border border-black/10 rounded-2xl p-5 text-center hover:shadow-md hover:border-black/20 transition-all opacity-80">
