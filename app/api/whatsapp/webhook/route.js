...
⏰ الدوام: {Open Time} - {Close Time} (حوّل الوقت لنظام 12 ساعة مثل 9:00 صباحاً - 9:00 مساءً، 8:00 صباحاً - 11:00 مساءً)
🕒 الحالة: اذا فاتح اكتب ✅ فاتح الآن حتى {Close Time بنظام 12 ساعة}، واذا مغلق اكتب ❌ مغلق الآن - يفتح الساعة {Open Time بنظام 12 ساعة}
