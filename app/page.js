      ...
      >
        ...
        >
          ...
          <p style={{ fontSize: 14, lineHeight: 1.7, opacity: 0.9, marginBottom: 18 }}>
            واجهة دخول موحّدة لإدارة الطلبات من المتاجر، الخدمات المميزة، الكوبونات، النقاط، المحفظة الرقمية،
        ...
        >
          ...
          <p style={{ fontSize: 11, opacity: 0.7, marginTop: 10 }}>
            منصة MD‑Marketplace لإدارة الطلبات من المتاجر، الخدمات المميزة، الكوبونات، النقاط، المحفظة الرقمية،
            وتتبع خدمات التوصيل الخاصة، مع دعم كامل لجميع المنتجات والمتاجر والمحلات العالمية.
          </p>
        </div>
      </div>
    </main>
