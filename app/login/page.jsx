          ...
          <div className="glass rounded-3xl overflow-hidden">
            ...
            <form onSubmit={handleRegisterClick} className="p-6 space-y-4">
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input name="area" value={form.area} onChange={handleChange} placeholder="اختر منطقتك" className="w-full bg-white/5 border border-white/10 rounded-2xl py-4 pr-12 pl-4 text-white placeholder-purple-300/50 focus:outline-none focus:ring-2 focus:ring-purple-500" required />
                  </div>
                </div>
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input name="address" value={form.address} onChange={handleChange} placeholder="أدخل عنوانك بالتفصيل" className="w-full bg-white/5 border border-white/10 rounded-2xl py-4 pr-12 pl-4 text-white placeholder-purple-300/50 focus:outline-none focus:ring-2 focus:ring-purple-500" required />
                  </div>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="relative">
                  <Lock className="absolute right-4 top-1/2 -translate-y-1/2 w-5 h-5 text-purple-300" />
                  <input name="pin" type="password" value={form.pin} onChange={handleChange} placeholder="اختر رمز دخول قوي" className="w-full bg-white/5 border border-white/10 rounded-2xl py-4 pr-12 pl-4 text-white placeholder-purple-300/50 focus:outline-none focus:ring-2 focus:ring-purple-500" required />
                </div>
              </div>
